...
import com.example.roarui.Component.Annotations.ValidPhoneNumber;
...
public class UserForm implements FormModel<UserForm> {
    ...
    public UserForm(String username, String firstName, String lastName, String email, String phone, String password, String dialCode, Date birthDate) {
